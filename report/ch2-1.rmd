...
```
<div class="footnote">^a^ *New and relapse* includes cases for which the treatment history is unknown. It excludes people who were re-registered as *treatment after failure*, as *treatment after lost to follow up* or as *other previously treated* (whose outcome after the most recent course of treatment was unknown or undocumented). In the new WHO guidance on TB surveillance published in 2024 (`r ref_lnk("1")`), the terminology of “new and relapse” has been replaced with “new episode”. The updated terminology will be used in WHO’s 2025 round of global TB data collection and, subsequently, throughout the Global TB Report. 
<br>^b^ RR-TB, rifampicin-resistant TB; MDR-TB, multidrug-resistant TB (defined as TB that is resistant to rifampicin and isoniazid). This column excludes any cases with known resistance to any fluoroquinolone.<br />^c^ XDR-TB, extensively drug-resistant TB. Pre-XDR-TB is defined as TB that is resistant to rifampicin and to any fluoroquinolone. XDR-TB is TB that is resistant to rifampicin and to any fluoroquinolone, and to at least one of bedaquiline or linezolid.</div>

<hr />
<br />

The `r ftb(f2.1.1_txt2$c_newinc_2023)` million people newly diagnosed and notified with TB in `r report_year - 1` is the highest number for a single year since WHO started to compile data from all countries and areas in the mid-1990s, up from the previous record of `r ftb(f2.1.1_txt2$c_newinc_2022)` million in `r report_year - 2` and `r ftb(f2.1.1_txt2$pct_2023)`% higher than the pre-pandemic level of `r ftb(f2.1.1_txt2$c_newinc_2019)` million in 2019 (`r lnk("Fig. 2.1.1")`). These two years of record levels of TB case notifications follow two years of COVID-related disruptions to health services, when TB case notifications fell considerably below pre-pandemic levels, most noticeably in 2020 (with a global reduction of `r round(f2.1.1_txt$pct_dif, 0)*(-1)`%, to `r ftb(f2.1.1_txt2$c_newinc_2020)` million) before a partial recovery in 2021 (to `r ftb(f2.1.1_txt2$c_newinc_2021)` million). 

The historically high numbers in 2022 and 2023 show that there has been a strong global recovery in the provision of and access to TB diagnosis and treatment. It is likely that they also reflect two other factors: the diagnosis of a backlog of people who developed TB in previous years but whose diagnosis was delayed by COVID-related disruptions, and an estimated increase in the overall number of people developing TB disease (<span style="color:#F21905">Section 1.1)</span>.
...
The pattern in the South-East Asia Region is very similar to the global trend, with a big reduction (-24%) between 2019 and 2020 followed by a partial recovery in 2021 and then a strong rebound to above the pre-COVID level in 2022&#8211;`r report_year-1`; indeed, it is this region that drove the trend at global level. There were similar patterns in the Eastern Mediterranean Region (mostly influenced by trends in Pakistan) and the Region of the Americas. 

In the European Region, notifications fell at a rate above the historic trend in 2020, increased in 2021 (likely representing some backlog from 2020) and then returned to a downward trend in 2022&#8211;`r report_year-1`. In the Western Pacific Region, case notifications in `r report_year-1` recovered to the 2019 level, following a big drop in 2020&#8211;2021. The recovery in `r report_year-1` in the Western Pacific Region was driven by China and the Philippines, which together accounted for `r ftb(f2.1.2_txt_WPR$pct)`% of total notifications in the region in the five years 2019&#8211;`r report_year-1` (`r lnk("Fig. 2.1.3")`). 

It is striking that notifications in the African Region increased throughout the pandemic and that this has continued in its aftermath. In `r report_year-1`, the reported number of people newly diagnosed with TB was `r ftb(f2.1.2_txt_AFR$pct)`% above the level of 2019.
...
<hr />
<br />
By `r report_year-1`, case notifications in most of the 30 high TB burden and three global TB watchlist countries had recovered to the pre-COVID level or beyond (`r lnk("Fig. 2.1.3")`). 
The exceptions were Angola, Lesotho, Liberia, Mongolia, Myanmar, Thailand and Zimbabwe. Two countries reported declines during and after the COVID-19 pandemic that were consistent with historic trends: the Democratic Republic of Korea and the Russian Federation.
...
<hr />
<br />
Although the global proportion of notified cases accounted for by children aged 0&#8211;14 years has been relatively stable (`r lnk("Fig. 2.1.4")`), there is considerable variation at country level (`r lnk("Fig. 2.1.5")`). Among the 30 high burden countries, those with particularly low levels (<5%) included `r gsub("Viet Nam", "Viet&nbsp;Nam", gsub("(Philip)|(Democ)|(Russian)", "the \\1\\2\\3", knitr::combine_words(f2.1.4b_hbc_low_data$country, oxford_comma=FALSE)))`.
...
### `r anch("Fig. 2.1.5")`<span class="red">Fig. 2.1.5</span> Percentage of people notified as a new or relapse case of TB who were aged 0&#8211;14 years,^a^ by country, `r report_year-1`

```{r fig_2.1.5, fig.alt="Map showing percentage of new and relapse TB cases that were children"}
...
### `r anch("Fig. 2.1.6")`<span class="red">Fig. 2.1.6</span> Percentage of people notified as a new or relapse case of TB who were diagnosed with extrapulmonary TB, by country, `r report_year-1`

```{r fig_2.1.6, fig.alt="Map showing percentage of extrapulmonary cases among new and relapse TB cases"}
...
<hr />
<br />
There is striking country variation in the distribution of TB case notifications according to country of origin (`r lnk("Fig. 2.1.7")`). In several countries with a low incidence of TB, more than 75% of notified cases were among people of foreign origin.


### `r anch("Fig. 2.1.7")`<span class="red">Fig. 2.1.7</span> Percentage of people notified as a TB case (new, relapse or retreatment) who were of foreign origin, by country, `r report_year-1`
...
Data about the number of people notified as a new and relapse case of TB who were registered in prisons have been collected from all countries in the European Region since 2014 and from all countries in the Region of the Americas since 2018. Data collection was expanded to all countries in 2023; `r ftb(f2.1.8_txt %>% nrow())` countries and areas reported data. These data reveal considerable country variation in the percentage of people notified as a new and relapse case of TB who were registered in prisons (`r lnk("Fig. 2.1.8")`). The highest percentages are in countries and areas in the Region of the Americas.

### `r anch("Fig. 2.1.8")`<span class="red">Fig. 2.1.8</span> Percentage of people notified as a new and relapse case of TB who were registered in prisons, by country, `r report_year-1`
...
There is considerable country variation in the percentage of people notified as a TB case by public-private mix initiatives (`r lnk("Fig. 2.1.10")`).

### `r anch("Fig. 2.1.10")`<span class="red">Fig. 2.1.10</span> Percentage of people notified as a TB case by public-private^a^ mix initiatives, by country,^b^ `r report_year - 1`
...
f2.1.10_plot <- f2.1.10_data %>% 
  ...
  whomap(colours = brewer.pal(5, "OrRd"),
         legend.title = "Percentage (%)",
         na.col = "white",
         water.col = "white")
...
f2.1.11_plot <- f2.1.11_data %>% 
  ...
  whomap(colours = brewer.pal(4, "RdYlBu"),
         legend.title = "",
         na.col = "white",
         water.col = "white")
...
<hr />
<br />
Zoonotic TB is a form of TB in people caused by a subspecies of the <i>M. tuberculosis</i> complex that is usually found in animals, such as <i>M. bovis, M. orygis, M. caprae or M. pinnipedii</i>. In `r report_year-1`, `r ftb(zoonotic_country)` countries reported cases of zoonotic TB to WHO; the total number of cases was `r ftb(zoonotic_cases$zoonotic)` (`r lnk("Fig. 2.1.12")`). This low number suggests that detection of zoonotic TB remains sub-optimal.

### `r anch("Fig. 2.1.12")`<span class="red">Fig. 2.1.12</span> Countries with people diagnosed with zoonotic TB, `r report_year-1`
...
f2.1.12_plot <- f2.1.12_data %>% 
  ...
  whomap(colours = palatte_fig2.1.12,
         legend.title = "",
         na.col = "white",
         water.col = "white")
...
1. Consolidated guidance on tuberculosis data generation and use: module 1: tuberculosis surveillance. Geneva: World Health Organization; 2024  (https://iris.who.int/handle/10665/376612).

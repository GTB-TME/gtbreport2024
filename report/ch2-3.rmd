...
At the second United Nations (UN) high-level meeting on TB in September 2023, Member States adopted a target that, by 2027, at least 90% of the estimated number of people who develop TB disease should be provided with quality-assured diagnosis and treatment (`r ref_lnk("1")`).

There are still wide gaps between the estimated number of people who develop TB each year (incident cases; see <span class="red">Section 1.1</span> for further details) and the number of people newly diagnosed with TB and officially reported as a TB case (`r lnk("Fig. 2.3.1")`). This reflects a mixture of (i) underdiagnosis and (ii) underreporting of people diagnosed with TB to national authorities. At the global level in `r report_year - 1`, the best estimate of the gap was `r ftb(f2.3.1_txt2$gap/1e6)` million (the difference between a best estimate of `r round(f2.3.1_txt2$e_inc_num/1e6,2)` million incident cases and `r round(f2.3.1_txt2$c_newinc/1e6,2)` million people who were newly diagnosed with TB and officially notified as a TB case). The gap has narrowed since 2020, a year in which it widened substantially (to a best estimate of `r ftb(f2.3.1_past %>% filter(year==2020) %>% select(gap)/1e6)` million) amid COVID-related disruptions in the first year of the pandemic.
...
Globally, there were steady improvements in TB treatment coverage between 2010 and 2019: from `r ftb(f2.3.2_txt$c_cdr_2010)`% in 2010 (95% uncertainty interval [UI]: `r ftb(f2.3.2_txt$c_cdr_lo_2010)`&#8211;`r ftb(f2.3.2_txt$c_cdr_hi_2010)`%) to `r ftb(f2.3.2_txt$c_cdr_2015)`% (95% UI: `r ftb(f2.3.2_txt$c_cdr_lo_2015)`&#8211;`r ftb(f2.3.2_txt$c_cdr_hi_2015)`%) in 2015 and then `r ftb(f2.3.2_txt$c_cdr_2019)`% (95% UI: `r ftb(f2.3.2_txt$c_cdr_lo_2019)`&#8211;`r ftb(f2.3.2_txt$c_cdr_hi_2019)`%) in 2019 (`r lnk("Fig. 2.3.2")`). Disruptions during the COVID-19 pandemic then resulted in a sharp reversal of progress in 2020: treatment coverage was only `r ftb(f2.3.2_txt$c_cdr_2020)`% (95% UI: `r ftb(f2.3.2_txt$c_cdr_lo_2020)`&#8211;`r ftb(f2.3.2_txt$c_cdr_hi_2020)`%), back to the level of 2015. Following the rebound in notifications of people newly diagnosed with TB between 2021 and 2023 (`r lnk("Fig. 2.3.2")`), TB treatment coverage at the global level appears to have recovered to above pre-pandemic levels (reaching a best estimate of `r ftb(f2.3.2_txt$c_cdr_2023)`% in `r report_year-1`). Some of the strong rebound in notifications in 2022 and 2023 likely reflects a backlog of people who developed TB in previous years (and were thus not truly “incident” cases), thus distorting estimates of treatment coverage in these years, as well as estimated increases in TB incidence. Further efforts are needed to reach the global target of 90% by 2027.

Trends among the six WHO regions vary. Treatment coverage remained below pre-pandemic levels in the Region of the Americas as well as the European and Western Pacific regions in `r report_year-1`. TB treatment coverage was highest in the South-East Asia Region (with a best estimate of `r ftb(f2.3.3_txt$c_cdr_SEA)`%).
...
<div class="subhead">The grey dashed line represents the global target of 90% by 2027 that was set at the 2023 UN high-level meeting on TB.</div>  
...
f2.3.2a_plot <- f2.3.2a_data %>% 
  ...
  annotate("text", x = 2016.5, y = 94, label = "Target: 90% by 2027",size=4, col="grey10") +
...
Among the 30 high TB burden countries, most countries made progress in 2023 but estimated levels of treatment coverage vary considerably (`r lnk("Fig. 2.3.3")`). 

Those with the highest levels in `r report_year-1` (>80%) included `r gsub("(Philip)|(Republic)|(Russian)", "the \\1\\2\\3", knitr::combine_words(f2.3.3_txt_list_hi$entity, oxford_comma=FALSE))`. As highlighted above for the global level, the estimates for these and other countries may be distorted by strong post-COVID recovery efforts that have resulted in large backlogs of people who developed TB in previous years being diagnosed relatively late, in `r report_year-1`. It is also possible that the notification data reflect some level of overdiagnosis of TB; for example, the proportion of notified cases diagnosed based on bacteriological confirmation in `r report_year-1` was less than 50% in Mozambique, Papua New Guinea and the Philippines (`r lnk("Fig. 2.2.4")` of <span class="red">Section 2.2</span>). The underlying estimates of TB incidence may also warrant review and would benefit from new studies  (such as a national TB prevalence survey or national TB inventory study) to directly measure the underlying burden of TB disease in the population. For example, the main data source used to inform the current estimates of TB incidence in Uganda and Zambia is national TB prevalence surveys that were implemented in 2015 and 2014, respectively (<span class="red">Section 1.4</span>). 

`r str_to_title(int2word(nrow(f2.3.3_txt_list_lo)))` high TB burden countries had particularly worrying levels of treatment coverage in `r report_year-1`, with best estimates of less than 50%: `r gsub("(Philip)|(Russian)|(Central)", "the \\1\\2\\3", knitr::combine_words(f2.3.3_txt_list_lo$entity, oxford_comma=FALSE))`.

### `r anch("Fig. 2.3.3")`<span class="red">Fig. 2.3.3</span> Estimated TB treatment coverage,^a^ 2010&#8211;`r report_year-1`, 30 high TB burden countries

```{r fig_2.3.3, fig.alt="Forest plot of TB treatment coverage in 30 countries, regionally and globally", fig.asp=1.3, eval=show_estimates}
...
<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_AGO"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_BGD"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_BRA"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_CAF"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_CHN"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_COG"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_PRK"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_COD"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_ETH"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_GAB"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_IND"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_IDN"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_KEN"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_LSO"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_LBR"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_MNG"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_MOZ"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_MMR"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_NAM"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_NGA"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_PAK"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_PNG"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_PHL"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_SLE"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_ZAF"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_THA"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_UGA"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_3_TZA"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_VNM"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_3_ZMB"></div>
</div>
</div>
...
Estimated treatment coverage is much lower among children than adults (`r lnk("Fig. 2.3.4")`). Globally in `r report_year-1`, treatment coverage was `r ftb(f2.3.4a_txt$c_cdr)`% (95% UI: `r ftb(f2.3.4a_txt$c_cdr_lo)`&#8211;`r ftb(f2.3.4a_txt$c_cdr_hi)`%) among people aged 0&#8211;14 years. The best estimate for those aged 15 years and above was `r ftb(f2.3.4b_txt$c_cdr)`%.

### `r anch("Fig. 2.3.4")`<span class="red">Fig. 2.3.4</span> Estimated TB treatment coverage^a^ among people aged 0&#8211;14 years and people aged &#8805;15 years in `r report_year-1`, 30 high TB burden countries, WHO regions and globally
...
<div class="footnote">^a^ Notifications of people with a new or relapse episode of TB as a percentage of estimated incident TB cases. TB treatment coverage in the European Region is underestimated, because at the time the data snapshot for this webpage was taken (`r format(as.Date(snapshot_date), format="%d %B %Y")`), `r EUR_no_data` countries had not yet reported notification data for `r report_year-1` to WHO.
<br />^b^ Log scale.</div>

<hr />
<br />

In `r report_year-1`, ten countries accounted for `r ftb(f2.3.5_txt2$pct_gap_top_ten)`% of the global gap between the estimated number of people who developed TB (incident TB cases) and the number of people who were diagnosed with TB and officially reported as a TB case (`r lnk("Fig. 2.3.5")`). About 50% of the global gap was accounted for by five countries: `r f2.3.5_txt %>% slice(1) %>% select(country)` (`r ftb(f2.3.5_txt %>% slice(1) %>% select(pct_gap))`%), `r f2.3.5_txt %>% slice(2) %>% select(country)` (`r ftb(f2.3.5_txt %>% slice(2) %>% select(pct_gap))`%), `r f2.3.5_txt %>% slice(3) %>% select(country)` (`r ftb(f2.3.5_txt %>% slice(3) %>% select(pct_gap))`%), `r f2.3.5_txt %>% slice(4) %>% select(country)` (`r ftb(f2.3.5_txt %>% slice(4) %>% select(pct_gap))`%) and `r f2.3.5_txt %>% slice(5) %>% select(country)` (`r ftb(f2.3.5_txt %>% slice(5) %>% select(pct_gap))`%).
...
Among people living with HIV who develop TB, both TB treatment and antiretroviral treatment (ART) for HIV are necessary to prevent unnecessary deaths from TB and HIV. Since 2019, the global coverage of ART for people newly diagnosed and reported with TB and known to be living with HIV has been maintained at a high level; for example, `r ftb(f2.3.6_txt$c_art_notified_2022)`% in 2022 and `r ftb(f2.3.6_txt$c_art_notified_2023)`% in 2023 (the blue curve compared with the black curve) (`r lnk("Fig. 2.3.6")`). 

However, when compared with the total estimated number of people living with HIV who developed TB in `r report_year-1` (the red curve), coverage was much lower, at `r ftb(f2.3.6_txt$c_art_estimated_2023)`%. This was an increase from `r ftb(f2.3.6_txt$c_art_estimated_2022)`% in `r report_year-2`. Among WHO regions, the highest coverage in `r report_year-1` was achieved in the African Region (a best estimate of `r ftb(f2.3.7_txt3 %>% slice(1) %>% select(c_art))`%), and the lowest in the Western Pacific Region (a best estimate of `r ftb(f2.3.7_txt3 %>% slice(2) %>% select(c_art))`%). 

All coverage estimates for people with TB are far below the overall coverage of ART for people living with HIV, which was 77% (UI: 61&#8211;89%) at the end of `r report_year-1` (`r ref_lnk("2")`). The main reason for relatively low coverage remains the big gap between the estimated number of people living with HIV who developed TB in `r report_year-1` and the number of people living with HIV who were reported to have been diagnosed with TB in `r report_year-1`.

Among the six WHO regions, the biggest gaps, where a half of the people living with HIV who developed TB were not reported in `r report_year-1`, were in the Eastern Mediterranean and Western Pacific regions (gaps of `r ftb(f2.3.6_region_txt %>% filter(g_whoregion=="EMR") %>% select(gap_hivpos_estimated_2023 ))`% and `r ftb(f2.3.6_region_txt %>% filter(g_whoregion=="WPR") %>% select(gap_hivpos_estimated_2023 ))`%, respectively).

### `r anch("Fig. 2.3.6")`<span class="red">Fig. 2.3.6</span> Estimated number of incident cases of TB among people living with HIV<span style="color:`r gtbreport::palette_gtb("inch")`;"> (red)</span> compared with the number of people notified with a new or relapse episode of TB who were known to be people living with HIV (black) and the global number of TB patients who were started on antiretroviral therapy<span style="color:#277abe;"> (blue)</span>, globally and for WHO regions, 2010&#8211;`r report_year-1`  
<div class="subhead">The shaded area represents the 95% uncertainty interval.</div>
...
## -- regional trend -- ##
f2.3.6b_plot <- f2.3.6_region_data %>% 
...
output_ggplot(f2.3.6b_plot, f2.3.6_region_data, show_static, pdf_csv_folder, save_csv, save_pdf)
...
<div class="row">
<div class="col-md-4">
<div id="fig_2_3_6_afro"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_6_amro"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_6_searo"></div>
</div>
</div>

<div class="row">
<div class="col-md-4">
<div id="fig_2_3_6_euro"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_6_emro"></div>
</div>
<div class="col-md-4">
<div id="fig_2_3_6_wpro"></div>
</div>
</div>
...
Among the 30 high TB/HIV burden countries, best estimates of the coverage of ART among people living with HIV who developed TB in `r report_year-1` varied widely, from `r ftb(f2.3.7_txt$c_art_bottom)`% in the `r f2.3.7_txt$entity_bottom` to `r ftb(f2.3.7_txt$c_art_top)`% in `r f2.3.7_txt$entity_top`; only `r f2.3.7_txt$over_50` of these 30 countries achieved coverage of at least 50% (`r lnk("Fig. 2.3.7")`).
...
<br />^b^ Data were not reported by China.</div>

<hr />
<br />

Globally, the treatment success rate for people treated for TB with first-line regimens was `r ftb(f2.3.8_txt$tsr_Global)`% in `r report_year-2` (the latest year for which treatment outcome data are available), and ranged from `r ftb(f2.3.8_txt$tsr_AMR)`% in the WHO Region of the Americas to `r ftb(f2.3.8_txt$tsr_EMR)`% in the WHO Eastern Mediterranean Region (`r lnk("Fig. 2.3.8")`). 
...
Globally, there were steady improvements in the treatment success rate between 2016 and `r report_year-2`: from `r ftb(f2.3.9_2016_txt$overall)`% in 2016 to `r ftb(f2.3.9_txt$overall)`% in `r report_year-2` (`r lnk("Fig. 2.3.9")`). The treatment success rate remains lower among people living with HIV, at `r ftb(f2.3.9_txt$hivpos)`% globally in `r report_year-2`, although there have been considerable improvements over time.
...
Among the 49 countries in one of the three global lists of high burden countries (for TB, HIV-associated TB and MDR/RR-TB) being used by WHO in the period 2021&#8211;2025 (see <span class="red">Annex 3</span> of the core report document), `r ftb(f2.3.11_txt2)` reported treatment outcome data disaggregated by sex; the treatment success rate in women and girls was `r ftb(f2.3.11_txt$value)`% in `r report_year-2`, slightly higher than (but very similar to) that among men and boys (`r lnk("Fig. 2.3.11")`).

### `r anch("Fig. 2.3.11")`<span class="red">Fig. 2.3.11</span> Treatment outcomes for people diagnosed with a new or relapse episode of TB disaggregated by sex for `r ftb(f2.3.11_txt2)` high burden countries that reported data,^a^ 2019&#8211;`r report_year-2` 
...
The treatment success rate for people aged 0&#8211;14 years was `r ftb(f2.3.12_txt$tsr_014_Global)`% in `r report_year-2` (`r lnk("Fig. 2.3.12")`). Among the six WHO regions, the best treatment success rate among people aged 0&#8211;14 years was achieved in the Eastern Mediterranean Region.
...
<div class="footnote">^a^ Data were reported by `r f2.3.12_txt$countries` countries on outcomes for `r int_spacer(f2.3.12_txt$kids_coh)` people aged 0&#8211;14 years, equivalent to `r ftb(f2.3.12_txt$kids_outcome_pct)`% of the `r int_spacer(f2.3.12_txt$kids_notified)` cases among people aged 0&#8211;14 years that were notified in `r report_year-2`.</div> 

<hr />
<br />

In combination, TB treatment and provision of ART to people living with HIV and diagnosed with TB are estimated to have averted `r ftb(t2.3.1_txt)` million deaths between `r lsaved_year` and `r report_year-1` (`r lnk("Table 2.3.1")`). The combination of TB treatment and ART for people living with HIV is estimated to have averted `r ftb(t2.3.1_hiv_txt)` million deaths between 2005, the first year following the release of an interim WHO policy on collaborative TB/HIV activities in 2004 (`r ref_lnk("3")`), and `r report_year-1`. 
...
A 4-month regimen composed of isoniazid, rifapentine, moxifloxacin and pyrazinamide (HPMZ) has been recommended by WHO for the treatment of rifampicin-susceptible TB since 2022 (`r ref_lnk("4")`). For people aged between 3 months and 16 years with non-severe TB, a 4-month regimen composed of isoniazid, rifampicin, pyrazinamide and ethambutol (2HRZ(E)/2HR) has been recommended by WHO since 2022 (`r ref_lnk("5")`). 

By the end of `r report_year - 1`, `r int2word(f2.3.13_hpmz_txt)` countries reported using the 4-month HPMZ regimen (`r knitr::combine_words(f2.3.13_txt_hpmz_list$country_in_text_EN, oxford_comma=FALSE)`), and `r f2.3.13_2hrze2hr_txt` countries and areas reported using the 4-month 2HRZ(E)/2HR regimen: `r knitr::combine_words(f2.3.13_txt_2hrze2hr_list$country_in_text_EN, oxford_comma=FALSE)` (`r lnk("Fig. 2.3.13")`).

### `r anch("Fig. 2.3.13")`<span class="red">Fig. 2.3.13</span> Countries that reported using 4-month regimens for treatment of rifampicin-susceptible TB by the end of  `r report_year-1`
...
var fig_2_3_2a_data = `r f2.3.2a_data %>% select(entity, year, c_cdr, c_cdr_lo, c_cdr_hi) %>% rename(value = c_cdr, lo = c_cdr_lo, hi = c_cdr_hi) %>% mutate(target=90) %>% toJSON("rows")`   ;
...
var fig_2_3_3_data = `r f2.3.3_data %>% select(entity, year, c_cdr, c_cdr_lo, c_cdr_hi) %>% rename(value = c_cdr, lo = c_cdr_lo, hi = c_cdr_hi) %>% toJSON("rows")`   ;
...
var fig_2_3_6b_data = `r f2.3.6_region_data %>% select(entity, year, hivpos, art, e_inc_tbhiv_num, e_inc_tbhiv_num_lo, e_inc_tbhiv_num_hi) %>% toJSON("rows")`   ;
...
function createFig_2_3_2a(fig_ID, data, filter, height) {
...
function createFig_2_3_2b(fig_ID, data, filter, height) {
...
function createFig_2_3_3(fig_ID, data, filter, height) {
...
function createFig_2_3_6b(fig_ID, data, filter, height) {
...
//				visible: false,
          ...
          template: "#= axis_spacer(value) #"
				...
				title: {
					text: "New and relapse cases per year",
					visible: true
				},
				line: {
					visible: false
...
function createFig_2_3_7(fig_ID, data, color) {
...
$(document).ready(function () {
  ...
  createFig_2_3_2a("#fig_2_3_2_global",fig_2_3_2a_data,"Global",500);
  createFig_2_3_2b("#fig_2_3_2_afro",fig_2_3_2b_data,"African Region",250);
  createFig_2_3_2b("#fig_2_3_2_amro",fig_2_3_2b_data,"Region of the Americas",250);
  createFig_2_3_2b("#fig_2_3_2_searo",fig_2_3_2b_data,"South-East Asia Region",250);
  createFig_2_3_2b("#fig_2_3_2_euro",fig_2_3_2b_data,"European Region",250);
  createFig_2_3_2b("#fig_2_3_2_emro",fig_2_3_2b_data,"Eastern Mediterranean Region",250);
  createFig_2_3_2b("#fig_2_3_2_wpro",fig_2_3_2b_data,"Western Pacific Region",250);

                  createFig_2_3_3("#fig_2_3_3_PHL",fig_2_3_3_data,"Philippines",250);
                  createFig_2_3_3("#fig_2_3_3_IND",fig_2_3_3_data,"India",250);
                  createFig_2_3_3("#fig_2_3_3_BRA",fig_2_3_3_data,"Brazil",250);
                  createFig_2_3_3("#fig_2_3_3_IDN",fig_2_3_3_data,"Indonesia",250);
                  createFig_2_3_3("#fig_2_3_3_LBR",fig_2_3_3_data,"Liberia",250);
                  createFig_2_3_3("#fig_2_3_3_GAB",fig_2_3_3_data,"Gabon",250);
                  createFig_2_3_3("#fig_2_3_3_KEN",fig_2_3_3_data,"Kenya",250);
                  createFig_2_3_3("#fig_2_3_3_PNG",fig_2_3_3_data,"Papua New Guinea",250);
                  createFig_2_3_3("#fig_2_3_3_BGD",fig_2_3_3_data,"Bangladesh",250);
                  createFig_2_3_3("#fig_2_3_3_UGA",fig_2_3_3_data,"Uganda",250);
                  createFig_2_3_3("#fig_2_3_3_PAK",fig_2_3_3_data,"Pakistan",250);
                  createFig_2_3_3("#fig_2_3_3_COG",fig_2_3_3_data,"Congo",250);
                  createFig_2_3_3("#fig_2_3_3_SLE",fig_2_3_3_data,"Sierra Leone",250);
                  createFig_2_3_3("#fig_2_3_3_LSO",fig_2_3_3_data,"Lesotho",250);
                  createFig_2_3_3("#fig_2_3_3_AGO",fig_2_3_3_data,"Angola",250);
                  createFig_2_3_3("#fig_2_3_3_MMR",fig_2_3_3_data,"Myanmar",250);
                  createFig_2_3_3("#fig_2_3_3_MNG",fig_2_3_3_data,"Mongolia",250);
                  createFig_2_3_3("#fig_2_3_3_VNM",fig_2_3_3_data,"Viet Nam",250);
                  createFig_2_3_3("#fig_2_3_3_THA",fig_2_3_3_data,"Thailand",250);
                  createFig_2_3_3("#fig_2_3_3_CAF",fig_2_3_3_data,"Central African Republic",250);
                  createFig_2_3_3("#fig_2_3_3_NGA",fig_2_3_3_data,"Nigeria",250);
                  createFig_2_3_3("#fig_2_3_3_COD",fig_2_3_3_data,"Democratic Republic of the Congo",250);
                  createFig_2_3_3("#fig_2_3_3_TZA",fig_2_3_3_data,"United Republic of Tanzania",250);
                  createFig_2_3_3("#fig_2_3_3_MOZ",fig_2_3_3_data,"Mozambique",250);
                  createFig_2_3_3("#fig_2_3_3_ZMB",fig_2_3_3_data,"Zambia",250);
                  createFig_2_3_3("#fig_2_3_3_CHN",fig_2_3_3_data,"China",250);
                  createFig_2_3_3("#fig_2_3_3_NAM",fig_2_3_3_data,"Namibia",250);
                  createFig_2_3_3("#fig_2_3_3_PRK",fig_2_3_3_data,"Democratic People's Republic of Korea",250);
                  createFig_2_3_3("#fig_2_3_3_ZAF",fig_2_3_3_data,"South Africa",250);
                  createFig_2_3_3("#fig_2_3_3_ETH",fig_2_3_3_data,"Ethiopia",250);
  ...
  createFig_2_3_6b("#fig_2_3_6_afro",fig_2_3_6b_data,"African Region",250);
  createFig_2_3_6b("#fig_2_3_6_amro",fig_2_3_6b_data,"Region of the Americas",250);
  createFig_2_3_6b("#fig_2_3_6_searo",fig_2_3_6b_data,"South-East Asia Region",250);
  createFig_2_3_6b("#fig_2_3_6_euro",fig_2_3_6b_data,"European Region",250);
  createFig_2_3_6b("#fig_2_3_6_emro",fig_2_3_6b_data,"Eastern Mediterranean Region",250);
  createFig_2_3_6b("#fig_2_3_6_wpro",fig_2_3_6b_data,"Western Pacific Region",250);
  
  createFig_2_3_7("#fig_2_3_7",fig_2_3_7_data,"#ed6476");

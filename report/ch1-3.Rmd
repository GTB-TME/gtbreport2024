...
The reason why the number of people developing MDR/RR-TB is not estimated to have increased from 2020--2023, in contrast to the number of people developing TB overall (<span class="red">Section 1.1</span>), is that increases in the overall number of people developing TB have been offset by an estimated downward trend since 2015 in the proportion of people with TB who have MDR/RR-TB, particularly among those with a previous history of treatment (`r lnk("Fig. 1.3.2")`).


Globally, the estimated proportion of new TB cases with MDR/RR-TB changed from `r ftb(f1.3_02_txt[1, "best"])`% (95% UI: `r ftb(f1.3_02_txt[1, "lo"])`--`r ftb(f1.3_02_txt[1, "hi"])`%) in 2015 to `r ftb(f1.3_02_txt[3, "best"])`% (95% UI: `r ftb(f1.3_02_txt[3, "lo"])`--`r ftb(f1.3_02_txt[3, "hi"])`%) in `r report_year-1`; the estimated proportion of previously treated cases with MDR/RR-TB was `r ftb(f1.3_02_txt[2, "best"])`% (95% UI: `r ftb(f1.3_02_txt[2, "lo"])`--`r ftb(f1.3_02_txt[2, "hi"])`%) in 2015 and `r ftb(f1.3_02_txt[4, "best"])`% (95% UI: `r ftb(f1.3_02_txt[4, "lo"])`--`r ftb(f1.3_02_txt[4, "hi"])`%) in `r report_year-1`.
...
Trends at regional level vary (`r lnk("Fig. 1.3.3")`). Between 2020 and `r report_year-1`, there were estimated increases in the number of people who developed MDR/RR-TB in the WHO Region of the Americas. In the WHO South-East Asia Region, after an increase in 2021 and 2022, the estimated number of people who developed MDR/RR-TB stabilized in 2023. In contrast, the estimated number of people developing MDR/RR-TB each year has been slowly declining since 2015 in the WHO African, Eastern Mediterranean and Western Pacific regions. Numbers are also estimated to have been falling for most of the period 2015--2023 in the WHO European Region, although there was a small blip in 2021 and the trend from 2022--2023 was stable. 
...
<hr />
<br />
`r f1.3_05_top |> nrow() |> int2word() |> stringr::str_to_sentence()` countries accounted for over half of the global number of people estimated to have developed MDR/RR-TB (incident cases) in `r report_year-1`: `r f1.3_05_top[1,"country_in_text_EN"]` (`r ftb(f1.3_05_top [1,"pct"])`% of global cases), `r f1.3_05_top[2,"country_in_text_EN"]` (`r ftb(f1.3_05_top [2,"pct"])`%), `r f1.3_05_top[3,"country_in_text_EN"]` (`r ftb(f1.3_05_top[3,"pct"])`%), `r f1.3_05_top[4,"country_in_text_EN"]` (`r ftb(f1.3_05_top[4,"pct"])`%) and `r f1.3_05_top[5,"country_in_text_EN"]` (`r ftb(f1.3_05_top[5,"pct"])`%) (`r lnk("Fig. 1.3.5")`). 
...
The proportion of people with TB who had MDR/RR-TB varies considerably among regions and countries (`r lnk("Fig. 1.3.6")`, `r lnk("Fig. 1.3.7")`). For people with no previous history of TB treatment (new cases), best estimates range from less than 3% in the WHO Africa, South-East Asia and Eastern Mediterranean regions to `r ftb(f1.3_06_txt[1, "e_rr_prop_new"]*100)`% in the `r f1.3_06_txt[1, "entity"]`. For people previously treated for TB, best estimates range from `r ftb(f1.3_07_txt[6, "e_rr_prop_ret"]*100)`% in the `r f1.3_07_txt[6, "entity"]` to `r ftb(f1.3_07_txt[1, "e_rr_prop_ret"]*100)`% in the `r f1.3_07_txt[1, "entity"]`. At country level, the highest proportions are found in the Russian Federation and in several countries in eastern Europe and Central Asia.  
...
Globally in `r report_year-1`, the estimated proportion of MDR/RR-TB cases with pre-XDR-TB (i.e. resistance to any fluoroquinolone for which testing was done) was `r ftb(FQR_in_RR_global$FQR.mid)`% (95% CI: `r ftb(FQR_in_RR_global$FQR.lo)`--`r ftb(FQR_in_RR_global$FQR.hi)`%). 
...
### `r anch("Fig. 1.3.9")`<span class="red">Fig. 1.3.9</span> Most recent year of data on rifampicin resistance for people diagnosed with TB, for those with no previous history of TB treatment, 2000--`r report_year-1`
...
### `r anch("Fig. 1.3.10")`<span class="red">Fig. 1.3.10</span> Number of data points on rifampicin resistance among people diagnosed with TB, for those with no previous history of TB treatment, 2000--`r report_year-1`
...
4. Guidance for the surveillance of drug resistance in tuberculosis: Sixth edition. Geneva: World Health Organization; 2020 (https://iris.who.int/handle/10665/339760). 

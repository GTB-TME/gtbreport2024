#' title: Estimate excess of TB deaths during COVID disruptions (2020:2023)
...
excess=sum(dta$mort.diff.num[dta$year==2020],dta$mort.diff.num[dta$year==2021],dta$mort.diff.num[dta$year==2022],dta$mort.diff.num[dta$year==2023])
excess.lo=sum(dta$mort.diff.lo.num[dta$year==2020],dta$mort.diff.lo.num[dta$year==2021],dta$mort.diff.lo.num[dta$year==2022],dta$mort.diff.lo.num[dta$year==2023])
excess.hi=sum(dta$mort.diff.hi.num[dta$year==2020],dta$mort.diff.hi.num[dta$year==2021],dta$mort.diff.hi.num[dta$year==2022],dta$mort.diff.hi.num[dta$year==2023])

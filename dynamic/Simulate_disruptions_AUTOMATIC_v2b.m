...
% Version 'b': Version used for countries where some degree of
% under-reporting is assumed
...
if contains(ctry,'region')
    ...
    if strcmp(iso3,'PHL')
        notif_rate(25:end) = notif_rate(25:end)*403/384;                   % 2022 notifications used for 2023 report were subsequently increased by 4%
    end
